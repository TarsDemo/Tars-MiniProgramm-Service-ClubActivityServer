...
func (_obj *DataService) DeleteClubWithContext(tarsCtx context.Context, club_id string, affectRows *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DataService) DeleteClubOneWayWithContext(tarsCtx context.Context, club_id string, affectRows *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DataService) DeleteClubManagerWithContext(tarsCtx context.Context, wx_id string, club_id string, affectRows *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DataService) DeleteClubManagerOneWayWithContext(tarsCtx context.Context, wx_id string, club_id string, affectRows *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DataService) UpdateActivityWithContext(tarsCtx context.Context, activityInfo *ActivityInfo, affectRows *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DataService) UpdateActivityOneWayWithContext(tarsCtx context.Context, activityInfo *ActivityInfo, affectRows *int32, _opt ...map[string]string) (ret int32, err error) {
...
type _impDataServiceWithContext interface {
	...
	DeleteClub(tarsCtx context.Context, club_id string, affectRows *int32) (ret int32, err error)
	DeleteClubManager(tarsCtx context.Context, wx_id string, club_id string, affectRows *int32) (ret int32, err error)
	...
	UpdateActivity(tarsCtx context.Context, activityInfo *ActivityInfo, affectRows *int32) (ret int32, err error)
...
func (_obj *DataService) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	...
	case "deleteClub":
		...
		if _withContext == false {
			_imp := _val.(_impDataService)
			_funRet_, err = _imp.DeleteClub(club_id, &affectRows)
		} else {
			_imp := _val.(_impDataServiceWithContext)
			_funRet_, err = _imp.DeleteClub(tarsCtx, club_id, &affectRows)
		}
	...
	case "deleteClubManager":
		...
		if _withContext == false {
			_imp := _val.(_impDataService)
			_funRet_, err = _imp.DeleteClubManager(wx_id, club_id, &affectRows)
		} else {
			_imp := _val.(_impDataServiceWithContext)
			_funRet_, err = _imp.DeleteClubManager(tarsCtx, wx_id, club_id, &affectRows)
		}
	...
	case "updateActivity":
		...
		if _withContext == false {
			_imp := _val.(_impDataService)
			_funRet_, err = _imp.UpdateActivity(&activityInfo, &affectRows)
		} else {
			_imp := _val.(_impDataServiceWithContext)
			_funRet_, err = _imp.UpdateActivity(tarsCtx, &activityInfo, &affectRows)
		}
